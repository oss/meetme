...
<CalendarView bind:this={calendar}>
  ...
  <fieldset class="fieldset bg-base-100 border-base-300 rounded-box border p-4">
    ...
    <textarea class="textarea textarea-xs textarea-ghost min-h-12 tetx-base" placeholder="Description"></textarea>
    ...
    <div class="flex gap-4">
      ...
      <button class="btn btn-sm btn-primary mt-2 grow-2">Save Settings</button>
    </div>
  </fieldset>
  <div class="tabs tabs-lift mt-4">
    <input type="radio" name="tabs" class="tab" aria-label="Calendar" checked="checked"/>
    <div class="tab-content bg-base-100 border-base-300 p-2">
      <calendar-date on:change={setDate} class="cally bg-base-100 border border-base-300 shadow-lg rounded-box">
